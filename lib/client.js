...
window.__ModuleLoader__.load({
  ...
  factory: function (require) {
    ...
    function AddRemoteModal({ isOpen, onClose }) {
      ...
      const [usePassword, setUsePassword] = (0, import_react.useState)(false);
      ...
      const handleTest = async () => {
        ...
        try {
          const res = await fetch("/dsh-ssh/api/test", {
            ...
            body: JSON.stringify({
              host: selectedHost,
              password: usePassword ? password : void 0
            })
          }).then((r) => r.json());
                  ...
                  /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
                    "label",
                    {
                      ...
                      children: [
                        ...
                        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "\u4F7F\u7528\u5BC6\u7801\u767B\u5F55 (Password Authentication)" })
                      ]
                    }
                  ),
                  usePassword && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { marginTop: "10px" }, children: [
                    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("label", { className: "dsh-ssh-label", children: [
                      "SSH \u767B\u5F55\u5BC6\u7801 ",
                      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { style: { color: "var(--dsw-alias-state-error-primary, #cf222e)" }, children: "*" }),
                      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { style: { fontWeight: "normal", color: "var(--dsw-alias-label-tertiary)", marginLeft: 6 }, children: "(\u7531\u6D4F\u89C8\u5668\u4FDD\u7BA1\uFF0C\u540E\u7AEF\u4EC5\u5B58\u5185\u5B58\u4E0D\u843D\u76D8)" })
                    ] }),
                    /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                      "input",
                      {
